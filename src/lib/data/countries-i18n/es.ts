...
const es: Record<string, CountryText> = {
  "MY": { summary: "El pase nómada DE Rantau (2022) y el programa de estancia prolongada MM2H (Malaysia My Second Home).", visaFreeNote: "Estancias cortas sin visado (hasta 90 días) para muchos pasaportes.", nomadNote: "Pase DE Rantau, lanzado en 2022.", healthcareNote: "Hospitales privados asequibles y de alta calidad; un polo de turismo médico.", vatNote: "SST (impuesto sobre ventas y servicios); sin un IVA general.", visaNotes: ["Trabajadores remotos/autónomos del sector tecnológico; renovable.", "Estancia prolongada mediante prueba de ahorros o ingresos.", "Patrocinado por el empleador."] },
  "VN": { summary: "Sin visado nómada específico; estancia prolongada mediante un e-visa de 90 días, residencia temporal o permiso de trabajo.", visaFreeNote: "Exención de visado de 45 días para algunos pasaportes; e-visa de 90 días para la mayoría.", nomadNote: "Sin visado específico; las renovaciones del e-visa son habituales.", healthcareNote: "Sistema público más clínicas privadas/internacionales en crecimiento; se recomienda seguro.", vatNote: "IVA (GTGT).", visaNotes: ["Entradas múltiples; usado de facto por los trabajadores remotos.", "Mediante trabajo, inversión o vínculo familiar.", "Patrocinado por el empleador."] },
  "KR": { summary: "El visado E-7 para trabajadores cualificados por puntos y las vías de residencia F-2; un visado nómada de workation (F-1-D) lanzado en 2024.", visaFreeNote: "K-ETA o estancias cortas sin visado para muchos pasaportes.", nomadNote: "Visado de workation F-1-D, 2024.", healthcareNote: "Excelente sistema universal NHIS; los expatriados se afilian tras unos 6 meses.", visaNotes: ["2024; trabajadores remotos, ingresos de ~65 000 $/año.", "Patrocinado por el empleador, lista de ocupaciones.", null] },
  "CZ": { summary: "La EU Blue Card y la Employee Card; el živnostenský list (licencia de actividad) es la vía clásica para autónomos y nómadas.", visaFreeNote: "Schengen 90/180 para muchos pasaportes.", nomadNote: "Programa de 2023 para determinadas nacionalidades del sector informático.", healthcareNote: "Seguro público obligatorio; de alta calidad y asequible.", incomeTaxNote: "15 % base, 23 % por encima de ~3× el salario medio.", visaNotes: ["Residencia y permiso de trabajo vinculados al empleador.", null, "Vía por cuenta propia usada por los nómadas.", "Programa de 2023 para determinadas nacionalidades del sector informático."] },
  "AT": { summary: "La Red-White-Red Card por puntos para trabajadores cualificados; la EU Blue Card.", visaFreeNote: "Schengen 90/180 para muchos pasaportes.", nomadNote: "Sin visado específico.", healthcareNote: "Seguro obligatorio universal; sistemáticamente entre los mejores valorados.", visaNotes: ["Por puntos, para trabajadores cualificados.", null, null] },
  "HU": { summary: "Un impuesto único sobre la renta del 15 % y el permiso de residencia para nómadas digitales White Card.", visaFreeNote: "Schengen 90/180 para muchos pasaportes.", nomadNote: "Permiso de residencia White Card.", healthcareNote: "Sistema público; los expatriados suelen sumar clínicas privadas.", vatNote: "El 27 % es el más alto de la UE.", taxNotes: ["El impuesto de sociedades del 9 % es el más bajo de la UE."], visaNotes: ["Trabajadores remotos, ingresos de ~3000 $/mes.", null, null] },
  "GR": { summary: "El Golden Visa (por inmueble) y un visado de nómada digital con una desgravación fiscal del 50 % para los nuevos residentes.", visaFreeNote: "Schengen 90/180 para muchos pasaportes.", nomadNote: "Visado de nómada digital y desgravación fiscal del 50 %.", healthcareNote: "Sistema público ESY; la atención privada es común entre los expatriados.", taxNotes: ["Exención del 50 % en el impuesto sobre la renta durante 7 años para los nuevos residentes fiscales que cumplan los requisitos."], visaNotes: ["Trabajadores remotos, 3500 €/mes; desgravación del 50 % en el IRPF.", "Inversión inmobiliaria de 250 000–800 000 €.", null] },
  "EE": { summary: "Pionera del Digital Nomad Visa y de la e-Residency; un sistema sencillo y digital ante todo.", visaFreeNote: "Schengen 90/180 para muchos pasaportes.", nomadNote: "Lanzó el primer DNV de Europa en 2020.", healthcareNote: "Seguro público; la sanidad más digital de la UE.", incomeTaxNote: "Tipo único; subió al 22 % en 2025.", taxNotes: ["Impuesto de sociedades al estilo estonio: se grava solo el beneficio distribuido."], visaNotes: ["El DNV original (2020); trabajadores remotos, 4500 €/mes.", "Gestiona una empresa de la UE en remoto — no es un permiso de residencia.", null] },
  "ID": { summary: "El nuevo KITAS E33G para trabajadores remotos (2024), además de un visado Second Home para jubilados e inversores.", visaFreeNote: "Visado a la llegada (30 días, prorrogable una vez) para muchos pasaportes.", nomadNote: "KITAS E33G para trabajadores remotos, lanzado en 2024.", healthcareNote: "Sistema público BPJS; los expatriados recurren a hospitales privados o a seguros internacionales.", incomeTaxNote: "Tramos del 5/15/25/30/35 %.", vatNote: "PPN; subiendo hacia el 12 %.", visaNotes: ["1 año; los ingresos del extranjero no tributan localmente.", "5–10 años; requisito de ahorros o propiedad.", "Patrocinado por el empleador."] },
  "CO": { summary: "El visado de nómada digital de tipo V y los visados de migrante de tipo M lo convierten en una base latinoamericana popular y asequible.", visaFreeNote: "90 días sin visado (prorrogables hasta 180 al año) para muchos pasaportes.", nomadNote: "Visado de nómada digital de tipo V, desde 2022.", healthcareNote: "Sistema público EPS; la atención privada es de alta calidad y económica.", vatNote: "IVA.", visaNotes: ["Hasta 2 años; ingresos de ~1000 $/mes.", "Vías por trabajo, matrimonio o inversión.", null] },
  "GE": { summary: "Un año entero de estancia sin visado para muchos ciudadanos, un célebre impuesto del 1 % para pequeñas empresas y el programa Remotely from Georgia.", visaFreeNote: "Sin visado hasta 365 días para ciudadanos de unos 95 países.", nomadNote: "Remotely from Georgia, más la estancia de 1 año sin visado.", healthcareNote: "Programa de sanidad universal; las clínicas privadas son baratas; se recomienda seguro.", incomeTaxNote: "Régimen del 1 % para pequeñas empresas sobre una facturación de hasta ~155 000 GEL.", taxNotes: ["Impuesto de sociedades al estilo estonio: se grava solo el beneficio distribuido."], visaNotes: ["~95 nacionalidades; base nómada de facto.", "Trabajadores remotos, ingresos de ~2000 $/mes.", null] },
  "BR": { summary: "El visado de nómada digital VITEM XIV; residencia por inversión, jubilación o vínculo familiar.", visaFreeNote: "90 días sin visado (prorrogables) para la UE y el R.U.; EE. UU., CA y AU necesitan un e-visa (2025).", nomadNote: "VITEM XIV, desde 2022.", healthcareNote: "SUS universal y gratuito; los expatriados suelen añadir un plan privado.", vatNote: "IVA estatal ICMS de ~17–20 %; más PIS/COFINS federales.", visaNotes: ["1 año, renovable; ingresos de ~1500 $/mes.", "Inversión empresarial de ~500 000 R$.", null] },
