...
const fr: Record<string, CountryText> = {
  "MY": { summary: "Le pass nomade DE Rantau (2022) et le programme de séjour longue durée MM2H (Malaysia My Second Home).", visaFreeNote: "Séjours courts sans visa (jusqu'à 90 jours) pour de nombreux passeports.", nomadNote: "Pass DE Rantau, lancé en 2022.", healthcareNote: "Hôpitaux privés abordables et de haute qualité ; un pôle du tourisme médical.", vatNote: "SST (taxe sur les ventes et les services) ; pas de TVA générale.", visaNotes: ["Travailleurs à distance et freelances de la tech ; renouvelable.", "Séjour longue durée sur justificatif d'épargne ou de revenus.", "Parrainé par l'employeur."] },
  "VN": { summary: "Pas de visa nomade dédié ; séjour longue durée via un e-visa de 90 jours, une résidence temporaire ou un permis de travail.", visaFreeNote: "Exemption de visa de 45 jours pour certains passeports ; e-visa de 90 jours pour la plupart.", nomadNote: "Pas de visa dédié ; les renouvellements d'e-visa sont courants.", healthcareNote: "Système public et cliniques privées/internationales en développement ; une assurance est recommandée.", vatNote: "TVA (GTGT).", visaNotes: ["À entrées multiples ; utilisé de facto par les travailleurs à distance.", "Par le travail, l'investissement ou la famille.", "Parrainé par l'employeur."] },
  "KR": { summary: "Le visa qualifié E-7 à points et les voies de résidence F-2 ; un visa nomade workation (F-1-D) lancé en 2024.", visaFreeNote: "K-ETA ou séjours courts sans visa pour de nombreux passeports.", nomadNote: "Visa workation F-1-D, 2024.", healthcareNote: "Excellent régime universel NHIS ; les expatriés s'y affilient après environ 6 mois.", visaNotes: ["2024 ; travailleurs à distance, revenus d'environ 65 000 $/an.", "Parrainé par l'employeur, liste de professions.", null] },
  "CZ": { summary: "L'EU Blue Card et l'Employee Card ; le živnostenský list (licence d'activité) est la voie classique pour les freelances et les nomades.", visaFreeNote: "Schengen 90/180 pour de nombreux passeports.", nomadNote: "Programme 2023 pour certaines nationalités dans l'informatique.", healthcareNote: "Assurance publique obligatoire ; de haute qualité et abordable.", incomeTaxNote: "15 % de base, 23 % au-delà d'environ 3 fois le salaire moyen.", visaNotes: ["Titre de séjour et permis de travail liés à l'employeur.", null, "Voie de travailleur indépendant utilisée par les nomades.", "Programme 2023 pour certaines nationalités dans l'informatique."] },
  "AT": { summary: "La Red-White-Red Card à points pour les travailleurs qualifiés ; l'EU Blue Card.", visaFreeNote: "Schengen 90/180 pour de nombreux passeports.", nomadNote: "Pas de visa dédié.", healthcareNote: "Assurance légale universelle ; régulièrement classée au sommet.", visaNotes: ["À points, pour les travailleurs qualifiés.", null, null] },
  "HU": { summary: "Un impôt forfaitaire sur le revenu de 15 % et la White Card, titre de séjour pour nomades numériques.", visaFreeNote: "Schengen 90/180 pour de nombreux passeports.", nomadNote: "Titre de séjour White Card.", healthcareNote: "Système public ; les expatriés recourent souvent en plus à des cliniques privées.", vatNote: "27 %, le taux le plus élevé de l'UE.", taxNotes: ["L'impôt sur les sociétés de 9 % est le plus bas de l'UE."], visaNotes: ["Travailleurs à distance, revenus d'environ 3 000 $/mois.", null, null] },
  "GR": { summary: "Le Golden Visa (immobilier) et un visa de nomade numérique assorti d'un abattement fiscal de 50 % pour les nouveaux résidents.", visaFreeNote: "Schengen 90/180 pour de nombreux passeports.", nomadNote: "Visa de nomade numérique + abattement fiscal de 50 %.", healthcareNote: "Système public ESY ; les soins privés sont courants pour les expatriés.", taxNotes: ["Exonération de 50 % de l'impôt sur le revenu pendant 7 ans pour les nouveaux résidents fiscaux éligibles."], visaNotes: ["Travailleurs à distance, 3 500 €/mois ; abattement de 50 % sur l'impôt sur le revenu.", "Investissement immobilier de 250 000 à 800 000 €.", null] },
  "EE": { summary: "Pionnier du visa de nomade numérique et de l'e-Residency ; un système simple, résolument numérique.", visaFreeNote: "Schengen 90/180 pour de nombreux passeports.", nomadNote: "A lancé le premier DNV d'Europe en 2020.", healthcareNote: "Assurance publique ; le système de santé le plus numérique de l'UE.", incomeTaxNote: "Taux forfaitaire ; porté à 22 % en 2025.", taxNotes: ["Impôt sur les sociétés à l'estonienne — prélevé uniquement sur les bénéfices distribués."], visaNotes: ["Le DNV original (2020) ; travailleurs à distance, 4 500 €/mois.", "Gérer à distance une société de l'UE — ce n'est pas un titre de séjour.", null] },
  "ID": { summary: "Le nouveau KITAS E33G pour travailleurs à distance (2024), ainsi qu'un visa Second Home pour les retraités et les investisseurs.", visaFreeNote: "Visa à l'arrivée (30 jours, renouvelable une fois) pour de nombreux passeports.", nomadNote: "KITAS E33G pour travailleurs à distance, lancé en 2024.", healthcareNote: "Régime public BPJS ; les expatriés recourent aux hôpitaux privés ou à une assurance internationale.", incomeTaxNote: "Tranches de 5/15/25/30/35 %.", vatNote: "PPN ; en hausse vers 12 %.", visaNotes: ["1 an ; les revenus étrangers ne sont pas imposés localement.", "5 à 10 ans ; condition d'épargne ou de bien immobilier.", "Parrainé par l'employeur."] },
  "CO": { summary: "Le visa de nomade numérique de type V et les visas de migrant de type M en font une base latino-américaine prisée et abordable.", visaFreeNote: "90 jours sans visa (prolongeables jusqu'à 180 par an) pour de nombreux passeports.", nomadNote: "Visa de nomade numérique de type V, depuis 2022.", healthcareNote: "Système public EPS ; les soins privés sont de grande qualité et peu coûteux.", vatNote: "IVA.", visaNotes: ["Jusqu'à 2 ans ; environ 1 000 $/mois de revenus.", "Voies liées au travail, au mariage ou à l'investissement.", null] },
  "GE": { summary: "Une année entière de séjour sans visa pour de nombreux ressortissants, un célèbre impôt de 1 % pour les petites entreprises et le programme Remotely from Georgia.", visaFreeNote: "Sans visa jusqu'à 365 jours pour les citoyens d'environ 95 pays.", nomadNote: "Remotely from Georgia, ainsi que le séjour sans visa d'un an.", healthcareNote: "Programme de couverture santé universelle ; les cliniques privées sont bon marché ; une assurance est recommandée.", incomeTaxNote: "Régime de 1 % pour les petites entreprises sur un chiffre d'affaires jusqu'à environ 155 000 GEL.", taxNotes: ["Impôt sur les sociétés à l'estonienne — prélevé uniquement sur les bénéfices distribués."], visaNotes: ["Environ 95 nationalités ; base nomade de fait.", "Travailleurs à distance, environ 2 000 $/mois de revenus.", null] },
  "BR": { summary: "Le visa de nomade numérique VITEM XIV ; résidence par investissement, retraite ou regroupement familial.", visaFreeNote: "90 jours sans visa (prolongeables) pour l'UE et le R.-U. ; les É.-U., le Canada et l'Australie ont besoin d'un e-visa (2025).", nomadNote: "VITEM XIV, depuis 2022.", healthcareNote: "SUS universel et gratuit ; les expatriés y ajoutent souvent une couverture privée.", vatNote: "TVA d'État ICMS d'environ 17 à 20 % ; plus les contributions fédérales PIS/COFINS.", visaNotes: ["1 an, renouvelable ; environ 1 500 $/mois de revenus.", "Investissement d'entreprise d'environ 500 000 R$.", null] },
